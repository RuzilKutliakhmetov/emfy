    ...
    window.onload = function () {
        ...
        oauth_scripts.forEach(function (oauth_script) {
            var client_id = oauth_script.dataset.clientId,
                ...
                title = oauth_script.dataset.title || 'РђРІС‚РѕСЂРёР·РѕРІР°С‚СЊСЃСЏ С‡РµСЂРµР· amoCRM',
            ...
            var centerAuthWindow = function (url, title) {
                var w = 750;
                var h = 580;
                var dual_screen_left = window.screenLeft !== undefined ? window.screenLeft : window.left;
                var dual_screen_top = window.screenTop !== undefined ? window.screenTop : window.top;

                var width = window.innerWidth
                    ? window.innerWidth
                    : (document.documentElement.clientWidth ? document.documentElement.clientWidth : window.width);

                var height = window.innerHeight
                    ? window.innerHeight
                    : (document.documentElement.clientHeight ? document.documentElement.clientHeight : window.height);
